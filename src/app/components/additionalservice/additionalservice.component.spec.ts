...
describe('AdditionalserviceComponent', () => {
  ...
  it('should call validateStep1 when type is tru', () => {
    component.type = true
    component.validateStep1()
    expect(component.validateStep1()).toBe(true)
  })

  it('should call validateStep1 when type is false', () => {
    component.type = false
    component.validateStep1()
    expect(component.validateStep1()).toBe(false)
  })

  it('should call validateStep2 when cost is true', () => {
    const instance = {
  ...
  it('should call validateStep2 when cost is false', () => {
    const errors = { someError: true } // Define un objeto de errores
    const instance = {
      cost: new FormControl('value') // Crea un nuevo FormControl con un valor y luego establece los errores
    }
    instance.cost.setErrors(errors) // Establece los errores manualmente
    const result = component.validateStep2.call(instance)
    expect(result).toEqual(false)
  })

it('should call validateStep3 when description is true', () => {
  const instance = {
...
it('should call validateStep3 when description is false', () => {
  const errors = { someError: true } // Define un objeto de errores
  const instance = {
    description: new FormControl('value') // Crea un nuevo FormControl con un valor y luego establece los errores
  }
  instance.description.setErrors(errors) // Establece los errores manualmente
  const result = component.validateStep3.call(instance)
  expect(result).toEqual(false)
})
